<?php if (defined('APP_RAN')) : ?>
    ...
    <div class="log-in">
        ...
        <form action="includes/login.inc.php" method="POST">
            <input type="text" name="email" placeholder="email" value="admin@gp.uk" autocomplete="off"/>
            <span class="field-error"><?php if (isset($_GET['error']) && $_GET['error'] == 'emptyemail') { echo 'email field required'; } ?></span>
            <input type="password" name="password" placeholder="password" value="password" autocomplete="off"/>
